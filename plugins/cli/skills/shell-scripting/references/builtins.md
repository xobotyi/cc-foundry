...
Prefer shell builtins over external commands. Each external command forks a process — in a loop, this creates
significant overhead. Shell builtins execute in-process and are both faster and more portable.
