...
See `${CLAUDE_SKILL_DIR}/references/configuration.md` for the full options catalog, library project setup, and project
structure guidance.
...
The **javascript** skill is a hard prerequisite. The JavaScript skill governs code patterns; this skill governs
type-level choices.
