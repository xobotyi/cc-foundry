...
stage. The pipeline produces three deliverables: the design document (what was decided and why),
the technical design (how at the component level), and the decomposition document with links
to tracked tasks.
