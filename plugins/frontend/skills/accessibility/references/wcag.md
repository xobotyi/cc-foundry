...
The Web Content Accessibility Guidelines (WCAG) 2.2 define success criteria organized under four principles:
Perceivable, Operable, Understandable, and Robust. Each criterion has a conformance level: A (minimum), AA (standard
