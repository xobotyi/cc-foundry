...
across all frontend work. The `tailwindcss` skill bridges CSS fundamentals and framework-specific class binding — it
routes to 9 reference files covering theme configuration, custom utilities, class authoring, framework integration,
layout, sizing, typography, backgrounds, and transforms/animations.
